...
```text
YYYY-MM-DD_summer_group-progress.md
```

Use this structure:

```markdown
# Funder Progress Check-in — [Date]
...
- [Milestone, workshop, experiment, or decision]
- Link to detailed notebook entries where available.

## Current project status

- [Workstream and current status]
- [Lead or contributor responsible]
